...
Z=92
call_method(12200) #XX KIVIS LABYRintRUM 3 XXXX Z=92 XXX  # 01921
if X==0 or X>6:
      goto(1918)  # 01922
...
Z=89
call_method(12200) #XX KIVIS LABYRintRUM 2 XXXX Z=89 XXX  # 01931
if X==0 or X>6:
      goto(1928)  # 01932
...
Z=93
call_method(12200) #XX KIVIS LABYRintRUM 4 XXXX Z=93 XXX  # 01952
if X==0 or X>6:
      goto(1956)  # 01953
...
Z=94
call_method(12200) #XX KIVIS LABYRintRUM 5 XXXX Z=94 XXX  # 01962
if X==0 or X>6:
      goto(1959)  # 01963
...
Z=95
call_method(12200) #XX KIVIS LABYRintRUM 6 XXXX Z=95 XXX  # 01972
if X==0 or X>6:
      goto(1969)  # 01973
...
print("Du är på stranden till en underjordisk sjö bredvid en enorm spelautomat.")# 02076
...
A[12]=0  # 02095
goto(2087)  # 02096
print( "Du fastnade i en jättesugkopp och kan inte komma loss."+FNS_("sover",15)  )# 02101
...
if S[2]==335 and random.random()>0.5:
     print("Plötsligt kommer Thorvald fram och säjer:")
goto(99160)  # 06002
if Z==70 and A1==1:
     print("På marken ligger en enorm rubin.")# 06003
if A[1]==Z:
     print("Det finns en diamant här.")# 06005
if A[15]==Z:
     print("Det ligger en kofot här.")# 06006
if A[16]==Z:
     print("Det står en cykelpump här.")# 06007
if A[2]==Z:
     print("Det finns en illaluktande gurka här.")# 06008
if A[3]==Z:
     print("Det finns en silvertacka här.")# 06009
if A[17]==Z and Z!= 11:
     print("Det står en stege här.")# 06010
if A[18]!= Z:
      goto(6014)  # 06011
if S[31]==0:
     print("Det finns en fylld brännvinsflaska här.")# 06012
if S[31]==1:
     print("Det finns en tom brännvinsflaska här.")# 06013
if A[19]!= Z:
      goto(6017)  # 06014
if S[32]==0:
     print("Det finns en fylld vattenflaska här.")# 06015
if S[32]==1:
     print("Det finns en tom vattenflaska här.")# 06016
if A[20]!= Z:
      goto(6020)  # 06017
if S[33]==0:
     print("Det finns en pumpad boll här.")# 06018
if S[33]==1:
     print("Det finns en opumpad boll här.")# 06019
if A[4]==Z:
     print("Det står en hillebard här.")# 06020
if A[21]==Z:
     print("Det står en spade här.")# 06021
if A[5]==Z:
     print("Det ligger en dödskalle här.")# 06022
if A[6]==Z:
     print("Det finns en väckarklocka här.")# 06023
if A[23]==Z:
     print("Det ligger en tunn telefonkatalog här.")# 06024
if A[12]==Z:
     print("Det ligger en faunsko här.")# 06025
if A[7]==Z:
     print("Det finns en massa guldmynt här.")# 06026
if J(Z)==1 and A[25]==Z:
     print("En telefon är inkopplad i en jack i väggen.")# 06027
if J(Z)==1 and A[25]!= Z and A[30]!= Z:
     print("Det finns en telefonjack i väggen.")# 06028
if J(Z)!= 1 and A[25]==Z and S[44]!= Z:
     print("Det finns en telefon här.")# 06029
if A[26]==Z:
     print("Det finns några nycklar här.")# 06030
if A[27]==Z:
     print("Det hänger en sax här.")# 06031
if A[28]==Z:
     print("Det hänger en slägga här.")# 06032
if A[22]==Z:
     print("Det ligger ett äckligt lik här.")# 06033
if A[11]==Z:
     print("Det finns ett glittrande pärlhalsband här.")# 06034
if A[8]==Z:
     print("Det ligger en trilogi här.")# 06035
if A[24]==Z:
     print("Det står en lampa här.")# 06036
if A[9]==Z:
     print("Det ligger ett kontrakt här.")# 06037
if A[10]==Z:
     print("Det hänger en lagerkrans här.")# 06038
if S[30]==Z:
      goto(6200)  # 06039
if J(Z)==1 and A[30]==Z:
     print("En förlängningssladd är inkopplad i en jack i väggen.")# 06040
if J(Z)!= 1 and A[30]==Z:
     print("Det ligger en förlängningssladd här.")# 06042
if J(Z)!= 1 and S[44]==Z and A[25]==Z:
     print("En telefon är inkopplad i en förlängningssladd.")# 06043
if S[44]==Z and (A[25]!= Z or J(Z)==1):
     print("En förlängningssladd sticker in hit.")# 06044
if S[44]==-1 and Z!= A[30]:
     S[44]=Z
print("Förlängningssladden räcker precis hit.")# 06048
if S[3]>0:
      goto(29000)  # 06050
if int(random.random()*20)!= 1 or S[50]<50:
      goto(6069)  # 06060
for i in range(1, 14):
    if A[i] == 1:
        S[3]=S[3]+1 # 06062
if S[3]>0:
     S[4]=int(random.random()*6)+int(S[3]/2+0.5)  # 06064
if int(random.random()*30)!= 1:
      goto(6100)  # 06069
if S[48]>0:
     print("En glasmästare springer förbi dej.")
S[48]=0  # 06070
if S[15]!= 1 and S[17]!= 1 and S[18]!= 1:
      goto(6076)  # 06072
print("En verkmästare från Stugas gatukontor lunkar förbi dej.")
S[15]=S[17]=S[18]=0  # 06074
if S[41]==1:
     print("En hissreparatör går förbi dej.")
S[41]=0
S[40]=int(random.random()*9)+1  # 06076
if S[50]-S[21]>25 and S[21]>0:
      goto(6130)  # 06098
if A[29]!= Z:
      goto(6120)  # 06100
if S[50]-S[51]>30 and S[51]>0:
      goto(6124)  # 06102
if S[6]==0:
     print("Här står en vakt.")# 06104
if S[6]==1:
     print("En full vakt raglar omkring här.")# 06106
if S[6]==2:
     print("Det finns blodfläckar på golvet.")
#? return  # 06108
if S[6]==3:
     print("En vakt sover här.")# 06110
if A[15]==2:
     print("Han har din kofot.")# 06112
if A[26]==2:
     print("Han har dina nycklar.")# 06114
if A[25]==2:
     print("Han bär på en telefon.")# 06116
if A[4]==2:
     print("Han bär på en juvelprydd hillebard.")# 06118
#? return  # 06119
if A[29]!= 1:
     pass #? return  # 06120
if S[50]-S[51]<31 and S[51]>0:
...
call_method(6000)  # 08334
A_=FNI_("")
call_method(12000)  # 08335
...
if FNL_(A_,5)=="SKRIK":
      goto(12550)  # 12060
if FNL_(A_,3)=="FAN" or FNL_(A_,5)=="JÄVLA" or FNL_(A_,6)=="DJÄVLA" or FNL_(A_,5)=="SATAN":
      goto(12555)  # 12061
...
if A_=="UT" or INSTR(1,A_," UT ")>0 or FNL_(A_,3)=="UT " or FNR_(A_,3)==" UT":
      goto(12420)  # 12081
if FNL_(A_,5)=="ÖPPNA":
      goto(12440)  # 12082
if FNL_(A_,5)=="STÄNG":
...
if FNL_(A_,4)=="FÖLJ":
      goto(12910)  # 12087
if A_=="IN" or INSTR(1,A_," IN ")>0 or FNL_(A_,3)=="IN " or FNR_(A_,3)==" IN" or INSTR(1,A_,"IGENOM")>0:
      goto(12400)  # 12088
if FNL_(A_,5)=="KASTA":
...
call_method(6000)  # 12201
print()# 12202
if S1<2:
     A_=FNI_("")
print()# 12203
call_method(12000)  # 12204
#? return  # 12208
...
goto(15058)   # 15078
call_method(6000) #XXXXX ALLMÄN GOSUBRUTIT XXXXX  # 15200
print()# 15202
if S1<2:
     A_=FNI_("")
print()# 15203
...
print("Du är i Hilbertrummet, ett rum med fyra dörrar och hål i taket och golvet.")# 15302
if A[17]==11:
     print("En stege är uppställd mot hålet i taket.")# 15304
call_method(12200)  # 15306
if X==0 or X>6:
      goto(15299)  # 15308
...
if X1==1:
      goto(20000)  # 20009
if X!= 0:
     goto([20030,9361,20200,20013,20020,20013,20011,20013,20070,2107][X])  # 20010
...
if S[53]==1:
  ...
  S[53]=S[53]+1  # 20032
call_method(15200)  # 20033
if X!= 0:
     goto([20055,20000,20020,20037,20040,20037,20035,20037,20200,2107][X])  # 20034
...
call_method(15200)  # 20158
if X!= 0:
     goto([20197,2115,20055,20165,20197,20197,20162,20180,20195,2107][X])  # 20161
call_method(11000)  # 20162
goto(20155)  # 20163
Z=82  #XXXXX SKOG 5 XXXXX Z=82 XXX  # 20165
print("Du är i skogen, sydväst om sjön.")# 20166
call_method(15200)  # 20168
if X!= 0:
...
call_method(15200)  # 20183
if X!= 0:
     goto([20165,2075,20191,20255,20155,20240,20188,2200,20191,2107][X])  # 20187
...
call_method(15200)  # 20273
if X!= 0:
     goto([2066,20285,20281,20300,20281,2200,20278,20315,20330,2107][X])  # 20277
...
call_method(15200)  # 20333
if X!= 0:
     goto([20340,20342,9424,20285,20340,20270,20338,20342,20342,2107][X])  # 20336
...
S=time.sleep(20)# 27404
#?if S:
#?    _ = input() # "  Var god dröj  "_A_
S=time.sleep(30)
goto(27406)  # 27406
...
STOP #&&&&&  )# 80355
if Z<20:
     goto([9991,15050,15000,15300,16000,16500,17000,25000,10020,40000,9300,2044][Z-7]) #&&&&&  # 80360
if Z<31:
     goto([2115,9000,9035,9065,9145,2075,9175,9100,9020,9190,21100][Z-19]) #&&&&&  # 80365
if Z<41:
     goto([21340,7570,2066,1909,7556,8300,8330,8071,8095,8365][Z-30]) #&&&&&  # 80370
if Z<51:
     goto([8381,8400,8000,8020,8035,15350,15370,15386,9361,2200][Z-40]) #&&&&&  # 80375
if Z<61:
     goto([2241,8420,1500,9490,9510,9545,9558,13000,13235,9528][Z-50]) #&&&&&  # 80380
if Z<71:
     goto([36000,13173,36050,14000,14100,20180,20240,20255,2019,20000][Z-60]) #&&&&&  # 80385
if Z<81:
     goto([20020,20030,20040,20055,20070,20085,20107,9390,20155,20143][Z-70]) #&&&&&  # 80390
if Z<91:
     goto([20200,20165,20270,20285,20300,20315,20330,9424,1929,15432][Z-80]) #&&&&&  # 80395
goto([2033,1919,1950,1960,1970,25130,8148,2150,2127,35000][Z-90]) #&&&&&  # 80400
...
J[78]=1
J[97]=1  # 90052
W_[1]="Stugrådet: Thorvald, Kimmo Eriksson, Olle Johansson, Viggo Eriksson, DEC-op, Thord Andersson"  # 90054
...
_ = input() # "Vill du ge några synpunkter på STUGA"+A_
A_=FNC_(A_) #%%%%%  # 99302
if FNL_(A_,1)=="J":
      goto(99350) #%%%%%  # 99305
if FNL_(A_,1)=="N":
